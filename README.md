## Welcome to  [ # FAQ ]  HTML Code Sections
Minimal FAQ accordion made with vanilla JavaScript.
## Code Link
- Github:       [ Shashank Trivedi Dev ]---------( https://github.com/Shashank-Trivedi-dev/Simple-FAQ )
- Codepen:      [ @Shashank-Trivedi-Dev ]--------( https://codepen.io/Shashank-Trivedi-Dev/pen/NWeapze )
- Replit:       [ @Shashank-Trivedi-Dev ]--------( https://replit.com/@Shashank-Trivedi-Dev/Simple-FAQ )
- Website Blog: [ ShashankTrivedi.com ]----------( https://shashanktrivedi.com/section/Simple-FAQ/ )
